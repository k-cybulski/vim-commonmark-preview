...
fun CommonmarkPreview()
    if g:CommonmarkPreview == 1
        let l:cssStyle = "<style type=\"text/css\">body{margin:40px auto;max-width:640px;line-height:1.7;font-size:18px;color:\#444;padding:0 10px}h1{line-height:1.4}</style>"
